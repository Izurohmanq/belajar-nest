...
export class AddressService {
    constructor (
        ...
        private contactService: ContactService,  // ini make dari contact service karena udah pernah buat, terus sama jadi digunakan kembali, jangan lupa import pada address module
    ) {} 
    ...
    async checkAddressMustExist(contactId:number, addressId:number): Promise<Address>{
